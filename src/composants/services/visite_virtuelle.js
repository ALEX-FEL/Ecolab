            ...
            <div className="container-xxl py-6">
                <div className="container">
                        ...
                        <h2 class="concept-title mb-15 home-title home-section-title">L'outil  N° 1 Pour Les Visites Virtuelles</h2>
                            <div class="mt-2 fz-18 fw-500 concept-text">
                                <p>
                                    ...
                                    <p>Klapty est une plateforme et un outil en ligne pour créer et partager des visites virtuelles. C'est le premier réseau social de visites virtuelles auquel font confiance plus de 50'000 utilisateurs innovants. Les agents immobiliers, les photographes, les dronistes, les hôteliers, les entreprises et les créatifs adorent utiliser Klapty, car c'est facile et ne nécessite aucune compétence particulière. Accessible à la fois depuis votre ordinateur et votre smartphone, les visites immersives créées sur Klapty vous permettront de capter votre audience et de gagner en visibilité.</p>
                                <p>
                                    
                                </p>
                                                                  <a href="https://www.klapty.com/fr#" data-toggle="modal" data-target="#signupModal">
                    ...
                    Achetez ou louez votre prochaine propriété, bateau, voiture, avion et location saisonnière. Découvrez les musées, les vues aériennes, l&#39;art, les créations 3D, les chantiers en construction et les salons. Trouvez tous les commerces près de chez vous: Boutiques, écoles, showrooms, bureaux et lieux de détente.</p>
                                                    ...
                                                    <div class="text-center">
                                                            ...
                                                            <div class="col-12 col-sm-6 col-md-6 col-lg-6 my-3">
                                                                <a href="https://www.klapty.com/fr/exemple-visite-virtuelle-immobilier">
                                                                                                                                                                                                                        
                                                                    <img class=" lazyload br-10 w-100 thumbnail-shadow" alt="Découvrez Les Visites Virtuelles" src="assets/img/imgeco/2.jpeg"/>
                                                                </a>
                                                            </div>
                    
                                                            <div class="col-12 col-sm-6 col-md-6 col-lg-6 my-3">
                                                                <a href="https://www.klapty.com/fr/exemple-visite-virtuelle-hotel">
                                                                <img class="lazyload br-10 w-100 thumbnail-shadow" alt="Découvrez Les Visites Virtuelles" src="assets/img/imgeco/3.jpeg"/>
                                                                </a>
                                                            </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="w-100 concept row section-area--" >
                                            ...
                                            <h2 class="concept-title mb-15 home-section-title text-center home-title"> Comment Créer Des Visites Virtuelles Sur Klapty ? </h2>
                                                                    <h3 class="mb-15 text-center home-subtitle"> Facile Et Rapide </h3>
                                                                    <div class="mt-2 fz-18 fw-500 concept-text">
                    
                                                    <p><strong>Créez un compte :</strong> Pour commencer à utiliser Klapty, cliquez simplement sur le bouton «S’inscrire», c&#39;est rapide et gratuit.</p>
                    
                    <p><strong>Capturez vos photos :</strong> Klapty est compatible avec toutes les photos de smartphones, les photos panoramiques, les caméras 360 et toutes les photos (JPG).</p>
                    
                    <p><strong>Chargez vos photos sur Klapty : </strong>Cliquez sur « créer un visite », remplissez les informations nécessaires puis transférez toutes vos photos sur Klapty. C’est illimité et simple</p>
                    
                    <p><strong>Améliorez votre visite virtuelle:</strong> Profitez des fonctionnalités proposées par Klapty : Ajoutez des hotspots pour passer d&#39;une vue à l’autre, ajoutez des hotspots d&#39;informations «i», ajoutez des photos classiques 2D et bien plus encore. Votre visite sera encore plus interactive et offrira une expérience unique aux visiteurs et clients.</p>
                    ...
                    <p><strong>Partagez votre visite: </strong>Dès que vous avez publié la visite virtuelle, elle est prête à être partagée dans le monde entier ou encore intégrée sur tous les sites internet.</p>
                                                                            ...
                                                                            <div class="text-center">
                                                    <a href="https://www.klapty.com/fr/comment-creer-visite-virtuelle-360" >
                                                    <button class="btn btn-outline-primary btn-section">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="w-100 concept row section-area--" >
                                            ...
                                            <div class="col-12 col-md-6 col-lg-7 " id="s-content" >
                                                ...
                                                <div class="mt-2 fz-18 fw-500 concept-text">
                                                    <p>
                                                        <p>Maintenant que votre premi&egrave;re visite virtuelle est publi&eacute;e sur Klapty, vous vous demandez peut-&ecirc;tre : que dois-je faire ensuite ? Vous pouvez partager en ligne vos visites virtuelles et ainsi gagner en visibilit&eacute; et profiter des avantages qu&#39;elles vous offrent.</p>
                    ...
                    Cliquez sur le bouton &laquo; Partager &raquo; et copier le code Embed. Toutes les visites cr&eacute;&eacute;es sur Klapty peuvent &ecirc;tre int&eacute;gr&eacute;es sur la page d&eacute;sir&eacute;e de votre site Web.</p>
                    
                    <p><strong>Diffusez sur les r&eacute;seaux sociaux</strong><br />
                    Les visites virtuelles cr&eacute;&eacute;es sur notre plateforme Klapty peuvent &ecirc;tre partag&eacute;es sur les r&eacute;seaux sociaux tels que Facebook, Twitter, Linkedin, WhatsApp, Telegram, Quora, Tumblr, Reddit, etc.</p>
                    
                    <p><strong>Obtenir le code QR</strong><br />
                    Klapty g&eacute;n&egrave;re un code QR qui peut &ecirc;tre scann&eacute; afin d&#39;ouvrir directement la visite immersive. Vous pouvez sauvegarder le code QR sur votre t&eacute;l&eacute;phone, votre ordinateur ou encore l&#39;imprimer sur papier.</p>
                                                    </p>
                    ...
                    La visite virtuelle&nbsp;est un outil tr&egrave;s appr&eacute;ci&eacute; des photographes, des agents immobiliers et de tous, car elle est capable&nbsp;de montrer chaque recoin d&#39;un lieu, ce qui acc&eacute;l&egrave;re l&#39;ensemble des&nbsp;processus. La visite immersive vous fera gagner du temps et de l&#39;argent. Les propri&eacute;taires d&#39;h&ocirc;tels,&nbsp;BnB, restaurants et toutes soci&eacute;t&eacute;s&nbsp;sont &eacute;galement fans des visites virtuelles&nbsp;Klapty, qui permettent de d&eacute;couvrir leurs &eacute;tablissements et gagner en visibilit&eacute;.</p>
                    
                    <p>Votre profil Klapty et vos visites sont index&eacute;s sur divers moteurs de recherche (Google, Bing, Yandex, etc), ce qui est une force marketing de plus &agrave; vos cot&eacute;s grace au r&eacute;f&eacute;rencement naturel (SEO) : Soyez omnipr&eacute;sent sur internet.</p>
                                                    </p>
                                                                                </div>
                                            </div>
                                                        </div>
                    ...
                    Les visites virtuelles Klapty permettent de Communiquer de manière innovante et de vous démarquer de vos concurrents. Croyez-nous, les clients et visiteurs adorent les visites immersives, bien plus que les photos basiques ou les vidéos monotones.</p>
                    
                    <p><strong>Les visites virtuelles boostent votre image</strong><br />
                    Bien que les visites virtuelles deviennent de plus en plus populaires, de nombreuses entreprises hésitent encore à les utiliser, estimant qu&#39;elles sont trop chères ou compliquées à réalisées. Klapty a révolutionné la manière de créer et diffuser les visites virtuelles. Créez votre visite en quelques minutes et attirez de nouveaux clients facilement et rapidement.</p>
                    
                    <p><strong>Les visites immersives favorisent la créativité</strong><br />
                    Klapty offre des fonctionnalités presque infinies qui ne nécessitent aucune compétence particulière. Stimulez votre créativité et surprenez vos visiteurs ou clients avec des visites virtuelles à couper le souffle.</p>
                    
                    <p><strong>Rejoignez une nouvelle communauté sur Klapty</strong><br />
                    Klapty n&#39;est pas simplement le meilleur outil de création visite virtuelle, c’est également un site de découverte et de rencontre entre professionnels et passionnés de visite virtuelle.</p>
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="w-100 concept row section-area--" >
                                            ...
                                            <div class="col-12 col-md-6 col-lg-7 " id="s-content" >
                                                ...
                                                <div class="mt-2 fz-18 fw-500 concept-text">
                                                    <p>
                                                        <p>Les visites virtuelles, &eacute;galement appel&eacute;es visites immersives, sont un ensemble de photos reli&eacute;es entre elles afin que le&nbsp;visiteur puisse profiter pleinement de l&#39;exp&eacute;rience &laquo; Immersive &raquo;. Beaucoup de personnes consid&egrave;rent les visites virtuelles comme quelque chose de long et co&ucirc;teux &agrave; cr&eacute;er, Klapty prouve le contraire. Notre objectif est de rendre les visites virtuelles accessibles &agrave; tous et dans le monde entier. Toutes les visites Klapty peuvent &ecirc;tre visualis&eacute;es sur tous types d&rsquo;appareils en un simple clic: MAC, PC, Smartphone (iOs et Android), Tablette et masque de r&eacute;alit&eacute; virtuelle (VR).</p>
                                                    </p>
                                                                                    <a href="fr.html#"  data-toggle="modal" data-target="#signupModal"  >
                                                        <button class="btn btn-outline-primary btn-section">
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12" id="s-content">
                                                ...
                                                <div class="row main">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="assets/img/imgeco/1.png" class="card-img-top cursor-pointer lazyload" alt="Professionnels de l&#039;immobilier"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="assets/img/imgeco/section_1610555375-354707498.png" class="card-img-top cursor-pointer lazyload" alt="Photographes"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795223-445582474.png" class="card-img-top cursor-pointer lazyload" alt="Entreprises de construction"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795223-1010274549.png" class="card-img-top cursor-pointer lazyload" alt="Dronistes"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795223-2371153.png" class="card-img-top cursor-pointer lazyload" alt="Architectes et designers 3D"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                                <h3 data-mh="title" class="match card-title home-subtitle block-subtitle cursor-pointer">Architectes et designers 3D</h3>
                                                            </a>
                                                            <span class="card-text fz-16 fw-500" data-mh="desc">Vous r&eacute;alisez des vues 3D, du Home Staging 3D, ou des plans de sol ? Montrez&nbsp;votre travail sur Klapty et faites-vous mandater en&nbsp;ligne pour votre talent.</span>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795224-1129413895.png" class="card-img-top cursor-pointer lazyload" alt="Entrepreneurs, écoles et entreprises"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795224-1429789100.png" class="card-img-top cursor-pointer lazyload" alt="Tourisme, patrimoine et villes"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 br-5">
                                                        <div class="card">
                                                        <a href="https://www.klapty.com/fr/explorer"><img src="https://assets.klapty.com/uploads/blockimage/blockimage_1610795224-546616023.png" class="card-img-top cursor-pointer lazyload" alt="Artistes, influenceurs ou particuliers"/></a>
                                                        <div class="card-body">
                                                            <a href="https://www.klapty.com/fr/explorer">
                            ...
                            <div class="container">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="w-100 concept row section-area--" >
                                                                ...
                                                                <div class="col-12 col-md-6 col-lg-5 text-center my-auto mx-auto  order-1 order-sm-1 order-md-2 order-last ">
                                                <div class="col-12">
                                                    <img class="lazyload br-10 w-100" alt="Klapty Pro : Pour Aller Plus Loin" data-src="https://assets.klapty.com/uploads/homesection/section_1610555375-354707498.png"/>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-7  order-2 order-sm-2 order-md-1 " id="s-content" >
                                                <h2 class="concept-title mb-15 home-title home-section-title" >Klapty Pro : Pour Aller Plus Loin</h2>
                                                <div class="mt-2 fz-18 fw-500 concept-text">
                                                    <p>
                                                        <p>Nous avons cr&eacute;&eacute; des fonctionnalit&eacute;s suppl&eacute;mentaires sous la formule Pro et Gold suite &agrave; vos nombreuses demandes. Ces formulesvous permettront de : passer des visites virtuelles en mode priv&eacute;es, prot&eacute;ger la consultation de la visite par un mot de passe, personnaliser la visite avec vos propres logos, ajouter dans la visite le lien de votre site internet, ajouter un fond sonore audio mp3 ou encore ajouter un plan de sol, et bien plus encore.</p>
                                                                                    ...
                                                                                    <a href="https://www.klapty.com/fr/tarifs-visites-virtuelles-360" >
                                                        <button class="btn btn-outline-primary btn-section">
                    ...
                    <br />
                    En Janvier 2020, Klapty rend enfin la visite virtuelle accessible à tous et pour le monde entier.</p>
